...
import { HamburgerMenu } from '../assets/design/Header';
...
const Header = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm`}>
            <div className="flex items-center justify-between px-5 lg:px-7.5 xl:px-10 max-lg:py-4 ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}">
                <a className="block w-[12rem] xl:mr-8">
                    <img src={banner} width={190} height={40} alt='Style' className='inline-block items-center'/>
                </a>
